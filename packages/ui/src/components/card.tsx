...
function CardTitle({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "font-heading text-lg font-bold tracking-[-0.015em] group-data-[size=sm]/card:text-base",
        className
      )}
      {...props}
    />
